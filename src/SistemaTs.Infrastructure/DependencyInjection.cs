...
public static class DependencyInjection
{
    public static IServiceCollection AddSistemaTsInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHttpClient<IRicevuteClient, RicevuteSoapClient>()
            .ConfigurePrimaryHttpMessageHandler(CreateHandler);
        services.AddHttpClient<IInterrogazioniClient, InterrogazioniClient>()
            .ConfigurePrimaryHttpMessageHandler(CreateHandler);
        services.AddHttpClient<IDocumentoSpesaClient, DocumentoSpesaSoapClient>()
            .ConfigurePrimaryHttpMessageHandler(CreateHandler);
        services.AddHttpClient<ISegnalazioniClient, SegnalazioniSoapClient>()
            .ConfigurePrimaryHttpMessageHandler(CreateHandler);
